...
{
    public interface IHasRoomSetup
    {
        void Setup(EssentialsRoomPropertiesConfig config);
    }
    public class BasicPanelMainInterfaceDriver : PanelDriverBase, IDisposable
    {
        ...
        public void SetupChildDrivers(IBasicRoom room)
        {
            ...
            {
                var roomDriver_ = driver as IHasRoomSetup;
                roomDriver_?.Setup(roomConf);
            }
        ...
        public override void Show()
        {
            ...
            if (IsAuthorized) // divert to PIN if we need auth
            {
